...
** Project
#+begin_src emacs-lisp
(defun mg/project-scan-projects ()
  (interactive)
  (let ((dirs
    ...
    (message "Projects scanned.")))

(rg-define-search mg/project-rg-literal
  :query ask
  :format literal
  :files "everything"
...
(rg-define-search mg/project-rg-regexp
  :query ask
  :format regexp
  :files "everything"
  :case-fold-search smart
...
(use-package project
  ...
  (:map project-prefix-map
        ("I" . mg/project-scan-projects)
        ("s" . mg/project-rg-literal)
        ("g" . mg/project-rg-regexp)
